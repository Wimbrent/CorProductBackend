...
import com.example.corproduct.ConfirmationToken.ConfirmationToken;
import com.example.corproduct.ConfirmationToken.ConfirmationTokenService;
import com.example.corproduct.Email.EmailSender;
import com.example.corproduct.Models.User;
import com.example.corproduct.Models.UserRole;
...
public class RegisterService {
    ...
    public int enableUser(String email) { return userRepository.enabledUser(email); }
...
//        }
        User user = new User(request.getFirstName(), request.getLastName(), request.getUserName(), request.getEmail(),
                request.getPhone(), request.getQuestion(), request.getAnswer(), encoder.encode(request.getPassword()), UserRole.USER);
